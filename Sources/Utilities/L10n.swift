...
internal enum L10n {
    ...
    enum RecordingSettings {
        ...
        static var shortcutTriggerDesc: String {
            isCN ? "持续模式：双击单独修饰键开始/结束，也可以按住说话、松开结束；普通组合键按一次开始、再按一次结束。快速模式：按住快捷键录音，松开结束。" :
                "Continuous: double-press a modifier-only shortcut to start/stop, or hold it to talk and release to stop; press a key combo once to start and again to stop. Quick: hold the shortcut to record, release to stop."
        }
