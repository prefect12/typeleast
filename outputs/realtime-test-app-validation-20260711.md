...
- Full Swift suite: 548 passed, 3 existing snapshot tests skipped, 0 failures.
...
- Test settings are OpenAI Realtime / `zh-en` / `⌃⌥Space` / start at login disabled / press-and-hold disabled.
