...
class LanguageManagerTests: XCTestCase {
    ...
    func testL10nEnglishStrings() {
        ...
        XCTAssertEqual(L10n.RecordingSettings.holdMode, "Press and Hold")
        XCTAssertEqual(L10n.RecordingSettings.doubleTapMode, "Double Press to Toggle")
    ...
    func testL10nChineseStrings() {
        ...
        XCTAssertEqual(L10n.RecordingSettings.holdMode, "按住时录音")
        XCTAssertEqual(L10n.RecordingSettings.doubleTapMode, "双击切换")
